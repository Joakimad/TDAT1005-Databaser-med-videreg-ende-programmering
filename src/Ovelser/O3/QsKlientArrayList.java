...
public class QsKlientArrayList {
    ...
    public QsKlientArrayList(OppgaveOversiktArrayList oversikt) {
     ...
     */
    class Oppgave1ArrayList {
        public static void main(String[] args) {

            OppgaveOversiktArrayList oversikt = new OppgaveOversiktArrayList();
            QsKlientArrayList qs = new QsKlientArrayList(oversikt);

            String valg = qs.lesValg();
            while (valg != null) {
                qs.utførValgtOppgave(valg);
                valg = qs.lesValg();
            }
