...
public class TestBonusMedlem {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SilverMedlem b3 = new SilverMedlem(b2.getMedlNr(), b2.getPers(), b2.getInnmeldtDato(), b2.getPoeng());
        b3.registrerPoeng(50000);
        if (b3.finnKvalPoeng(testdato) == 90000 && b3.getPoeng() == 90000) {
            System.out.println("Test 4 ok");
        }

        GoldMedlem b4 = new GoldMedlem(b3.getMedlNr(), b3.getPers(), b3.getInnmeldtDato(), b3.getPoeng());
