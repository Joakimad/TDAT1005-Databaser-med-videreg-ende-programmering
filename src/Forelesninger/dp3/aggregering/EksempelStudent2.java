package Forelesning.dp3.aggregering;
/**
 ...
 * Klassen er laget s� enkel for � illustrere aggregering.
 * Poststedobjektet er "en-del-av" studentobjektet, men
 * det kan ogs� v�re "en-del-av" andre objekter.
 *
...
class Student2 {
	...
	public Student2(Poststed poststed, int studnr) {
...
/**
 * Enkel klient som oppretter et studentobjekt og pr�ver set-metodene.
 */
class EksempelStudent2 {
	public static void main(String[] args) {
		/* Oppretter et poststedobjekt som blir argument til Student-konstrukt�ren. */
		Poststed post = new Poststed("0345", "Oslo");
		Student2 studenten = new Student2(post, 56437);
		out("Etter at objektet er opprettet: " + studenten.toString());
		...
		out("Etter endring av data: " + studenten.toString());
	}
}

/*
 * Kj�ring av programmet: Etter at objektet er opprettet: Studentnr.: 56437,
 * postadresse: 0345 Oslo <leser inn nye data: "7025 Trondheim" og "12345">
