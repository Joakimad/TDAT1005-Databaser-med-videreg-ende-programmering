...
CREATE TABLE leilighet (
  ...
  FOREIGN KEY (eier) REFERENCES medlem(id_medlem),
  FOREIGN KEY (bygg) REFERENCES bygg(adr)
  );

  ALTER TABLE leilighet
  ADD CONSTRAINT eier_fk
  FOREIGN KEY (eier) REFERENCES medlem(id_medlem);

  ALTER TABLE leilighet
  ADD CONSTRAINT bygg_fk
  FOREIGN KEY (bygg) REFERENCES bygg(adr);
...
INSERT INTO leilighet (leilighetsNr,eier,bygg,etg,antRom,m2) VALUES (201,1,"Sollia 6b",2,3,25);
